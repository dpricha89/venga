...
//  Venga
//
//  Created by David Richards on 8/7/17.
...
public class MapViewController : UIViewController, TypedRowControllerType, MKMapViewDelegate {
    ...
    lazy var pinView: UIImageView = { [unowned self] in
        ...
        v.image = UIImage.fontAwesomeIcon(name: .mapMarker, textColor: GlobalConst.vengaWatermelon, size: CGSize(width: 25, height: 25))
